...
<h3 style="margin-top:10px ;color:#333;text-align: center"><?php echo ($title); ?></h3>
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading"><span style="position: relative;left: 0"><a href="<?php echo U('expUser');?>&item=2" class="btn">导出数据</a></span><span style="position: relative;left: 0"><a href="<?php echo U('index');?>" class="btn">返回接口总访问数据</a></span></div>
          <div class="panel-body">
            <table data-toggle="table" data-url="<?php echo U('getUser');?>&item=2"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                <thead>
                <tr>
