...
<h3 style="margin-top:10px ;color:#333;text-align: center"><?php echo ($title); ?></h3>
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading"><span style="position: relative;left: 0"><a href="<?php echo U('expUser');?>&item=1" class="btn">导出数据</a></span><span>总访客量 uv：<?php echo ($uv); ?> &nbsp;&nbsp;&nbsp;</span><span>总访问量 pv：<?php echo ($pv); ?></span><span style="position: relative;left: 0"><a href="<?php echo U('user');?>" class="btn">查看接口日调用次数</a></span><span style="position: relative;left: 0"><a href="<?php echo U('errorcode');?>" class="btn">查看接口调用错误次数</a></span></div>
          <div class="panel-body">
            <table data-toggle="table" data-url="<?php echo U('getUser');?>&item=1"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                <thead>
                <tr>
