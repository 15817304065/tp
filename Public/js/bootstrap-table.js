...
! function($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatRecordsPerPage: function(pageNumber) {
            return sprintf('%s 每页显示', pageNumber);
        },
        formatShowingRows: function(pageFrom, pageTo, totalRows) {
            return sprintf('展示 %s 到 %s 条记录，总共 <span style="color:#f00">%s</span> 条记录 ', pageFrom, pageTo, totalRows);
        },
    ...
    BootstrapTable.prototype.initContainer = function() {
        this.$container = $(['<div class="bootstrap-table">', '<div class="fixed-table-toolbar"></div>', '<div class="fixed-table-container">', '<div class="fixed-table-header"><table></table></div>', '<div class="fixed-table-body">', '<div class="fixed-table-loading">',
            this.options.formatLoadingMessage(), '</div>', '</div>', '<div class="fixed-table-pagination"></div>', '</div>', '</div>'
        ].join(''));
    ...
    BootstrapTable.prototype.initPagination = function() {
        ...
        var pageNumber = ['<span class="btn-group dropup">', '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">', '<span class="page-size">',
                this.options.pageSize, '</span>', ' <span class="caret"></span>', '</button>', '<ul class="dropdown-menu" role="menu">'
            ],
            ...
            $.each(this.header.fields, function(j, field) {
                ...
                if (that.options.columns[j].checkbox || that.options.columns[j].radio) {
                    ...
                    text = that.options.cardView ? ['<div class="card-view">',
                        ...
                        sprintf('<span class="value">%s</span>', value), '</div>'
                    ].join('') : [sprintf('<td%s %s %s>', id_, class_, style),
                        value, '</td>'
                    ].join('');
                }
                html.push(text);
